...
const domain = 'https://biophilia.finance'
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://app.biophilia.finance/ - check the URL carefully.", { domain })
    return warningText.split(/(https:\/\/app.biophilia.finance)/g)
  }, [t])
